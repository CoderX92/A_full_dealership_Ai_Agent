...
PRETTY STRAIGHT FORWARD STUFF HERE
  We are suing a csv file for booking, checking availability and cancelling of meetings
  Mary uses this tool if there is need to check this CSV. 
"""
...
#print(cancel_meeting.invoke('edwinmade54@gmail.com', reason='l am caught in traffic'))  # Maximum days in future allowed booking
) -> str:
    """Book a new meeting with real-time date validation. 
    Required: date (YYYY-MM-DD), hour (HH:MM), booked_by (name), client_email.
    Optional: reason.
